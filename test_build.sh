...
start_build_process() {
    ...
    git clone https://github.com/Sorayukii/android_device_sony_aurora -b 16.0-ax device/sony/aurora
    git clone https://github.com/Sorayukii/android_device_sony_tama-common -b 16.0 device/sony/tama-common
